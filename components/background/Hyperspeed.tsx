...
// Inline shader type for onBeforeCompile callback
...
const mountainUniforms: DistortionUniforms = {
  uFreq: { value: new THREE.Vector3(3, 6, 10) },
  uAmp: { value: new THREE.Vector3(30, 30, 20) },
};

const xyUniforms: DistortionUniforms = {
  uFreq: { value: new THREE.Vector2(5, 2) },
  uAmp: { value: new THREE.Vector2(25, 15) },
};

const LongRaceUniforms: DistortionUniforms = {
...
const deepUniforms: DistortionUniforms = {
  ...
  deepDistortionStill: {
    ...
    float getDistortionY(float progress){
      return (
        ...
        sin(progress * PI * uFreq.y) * uAmp.y
      );
    }
    vec3 getDistortion(float progress){
      return vec3(
...
const distortion_uniforms: DistortionUniforms = {
...
class CarLights {
  ...
  init() {
    ...
    material.onBeforeCompile = (shader: ShaderObject) => {
...
class Road {
  ...
  createPlane(side: number, width: number, isRoad: boolean) {
    ...
    let uniforms: Record<string, IUniform> = {
      uTravelLength: { value: options.length },
      uColor: {
...
class App {
  ...
  fogUniforms: Record<string, IUniform>;
  fovTarget: number;
...
export const Hyperspeed = forwardRef<
  HTMLDivElement,
  HyperspeedProps
>(({ className, effectOptions = {}, ...props }, ref) => {
  ...
  return (
    <div ref={ref} className={cn('w-full h-full', className)} {...domProps}>
      <div 
        id="lights" 
